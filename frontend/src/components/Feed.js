...
const Feed = ({ searchTerm, refreshFeed }) => {
    ...
    const handleEditOrder = () => {
        ...
        .then(() => {
            refreshFeed(); // Refresh the feed using the passed method
    ...
    return (
        <div className="feed">
            <QuickActions refreshFeed={refreshFeed} />
                ...
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        >
                            ...
                            {editingOrder.customer.orderStatuses.map((status) => (
